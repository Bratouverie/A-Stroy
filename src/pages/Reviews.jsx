...
const STATIC_REVIEWS = [
  { name: "Марина Петрова", role: "Владелица квартиры 120 кв.м", text: "Невероятное качество работы! Каждая деталь продумана до мелочей. Ремонт был сделан точно в срок, а результат превзошёл все ожидания.", rating: 5, project: "Квартира в центре Москвы", objectType: "Квартира", reviewType: "Владелец квартиры" },
  { name: "Алексей Иванов", role: "Владелец коттеджа", text: "Профессиональная команда, которая реально знает своё дело. Дизайн получился роскошным, а качество отделки на высшем уровне.", rating: 5, project: "Коттедж 300 кв.м", objectType: "Коттедж", reviewType: "Владелец коттеджа" },
  { name: "Елена Козлова", role: "Бизнес-леди", text: "Работали с А СТРОЙ уже дважды — и для квартиры, и для дачи. Оба раза результат был безупречным. Рекомендую всем!", rating: 5, project: "Дачный дом", objectType: "Дом", reviewType: "Бизнес-леди" },
  { name: "Дмитрий Соколов", role: "IT-предприниматель", text: "Качество работ и материалов на уровне премиум-класса. Менеджер был на связи 24/7. Превосходный сервис от начала до конца.", rating: 5, project: "Студия 80 кв.м", objectType: "Студия", reviewType: "Бизнесмен" },
];
