...
const projects = [
  { title: "Роскошная квартира", category: "Квартира", budget: "от 2.5 млн ₽", id: 0 },
  { title: "Студия Modern", category: "Квартира", budget: "от 1.5 млн ₽", id: 1 },
  { title: "Семейный дом", category: "Дом", budget: "от 3 млн ₽", id: 2 },
  { title: "Люкс коттедж", category: "Коттедж", budget: "от 8 млн ₽", id: 3 },
  { title: "Премиум кухня", category: "Квартира", budget: "от 2 млн ₽", id: 4 },
  { title: "Spa-ванная", category: "Квартира", budget: "от 1.8 млн ₽", id: 5 },
];
    ...
    <section id="portfolio" className="py-20 lg:py-28 bg-[#1A1F2E]/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <Link to="/portfolio" className="inline-flex items-center gap-2 text-[#D4AF37] font-medium hover:gap-3 transition-all">
